    const dadosRevisao = {
        V350: {
            ...
            tmo: { 1000: 0.0, 3000: 0.5, 6000: 0.5, 9000: 0.5, 12000: 2.0, 15000: 0.5, 18000: 1.5 }
        },
        T350: {
            1000: [
                { codigo: 'MT114', nome: 'Óleo do Motor', qtd: 2, valor: 70.00 },
        ...
        '350E': {
            ...
            tmo: { 1000: 0.0, 3000: 0.5, 6000: 0.5, 9000: 0.5, 12000: 1.5, 15000: 0.5, 18000: 2.5 }
        }
    };
    ...
    function calcular() {
        ...
        if (!veiculo || !km) {
            ...
            subTMOEl.textContent = '0,0 h × R$ 250,00/h';
        ...
        subTMOEl.textContent = `${tmoHoras.toFixed(1).replace('.', ',')} h × R$ 250,00/h`;
        subTotalEl.textContent = 'Peças + Mão de Obra';
